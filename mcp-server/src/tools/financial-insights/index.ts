...
import { type FinancialInsightsArgs, FinancialInsightsArgsSchema, type ToolInput } from '../../core/types/index.js';
...
export async function handler(
  ...
  try {
    const validatedArgs = FinancialInsightsArgsSchema.parse(args);
    const insights = await generateInsightsSummary(validatedArgs.month, {
      includeSchedules: validatedArgs.includeSchedules,
      scheduleDays: validatedArgs.scheduleDays,
    });
