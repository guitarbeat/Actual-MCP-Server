  ...
  describe('buildTimelineReconAudit', () => {
    ...
    it('should process uncategorized transactions and populate candidates', () => {
      const input: BuildTimelineReconAuditInput = {
        ...
        categoriesById: {
          c1: { id: 'c1', name: 'Test Category', is_income: false, group_id: 'g1' } as any,
        },
        supplementalRows: [],
        timeline: { stays: [], activities: [] },
        placeCache: { places: {} },
  ...
  describe('generateTimelineReconAudit', () => {
    it('should generate audit and write outputs', async () => {
      const paths = {
        ...
        supplementalCsvPath: '/test/supp.csv',
        placeCachePath: '/test/place.json',
        categoryOverridesPath: '/test/override.json',
        manualReviewCsvPath: '/test/manual.csv',
        candidatesCsvPath: '/test/candidates.csv',
        locationHistoryPath: '/test/loc.json',
        repoRoot: '/test',
        reconDir: '/test/base',
        timelinePath: '/test/timeline.json',
        candidatesPath: '/test/candidates.csv',
        manualReviewPath: '/test/manual.csv',
      };
